...
from package_dir.boundaryDomain import domain, obstacle, obstacleMath
from package_dir.initialConditions import initialCond
from package_dir.faceInterpolation import U_face, V_face
from package_dir.UV_coeff import U_coeffUpwind, V_coeffUpwind
from package_dir.P_coeff import P_coeffSIMPLE
from package_dir.correction import correctionSIMPLE
from package_dir.postProcessing import postProcessor
D, \
xMin, xMax, yMin, yMax, \
dx, dy, nx, ny, \
